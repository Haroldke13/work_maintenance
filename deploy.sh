...
configure_variables() {
    ...
    MAIL_SENDER_NAME="${MAIL_SENDER_NAME:-PBORA}"
    MAIL_DEFAULT_SENDER="${MAIL_DEFAULT_SENDER:-$MAIL_USERNAME}"
    NOTIFY_EMAILS="${NOTIFY_EMAILS:-jonyango@pbora.go.ke}"
    ADMIN_EMAIL="${ADMIN_EMAIL:-jonyango@pbora.go.ke}"
    SUPPORT_EMAIL="${SUPPORT_EMAIL:-ictsupport@pbora.go.ke}"
